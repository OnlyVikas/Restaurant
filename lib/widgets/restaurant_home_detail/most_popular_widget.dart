...
class MostPopularWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: FutureBuilder(
        future: viewModel.displayMostPopularByRestaurantId(mainStateController.selectedRestaurant.value.restaurantId),builder: (context,snapshot){
        ...
        else
        {
          ...
          return Column(
            ...
            children: [Text(mostPopularText, style: GoogleFonts.jetBrainsMono(fontWeight: FontWeight.w900,fontSize: 24,
              ...
              LiveList(
                ...
                itemBuilder: animationItemBuilder((index) => Container(
                  ...
                  child: Column(
                    ...
                    SizedBox(height:10),
                    Text(lstPopular[index].name,style: GoogleFonts.jetBrainsMono(),
                    )
                  ],
                  ),
                )),
