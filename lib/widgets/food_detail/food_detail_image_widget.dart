    ...
    return Column(
      children: [
        Container(
          ...
          child: Hero(tag: foodListStateController.selectedFood.value.name,
            ...
            child: Row(
              ...
              children: [
                ...
                FloatingActionButton(
                  ...
                  onPressed: () =>cartStateController.addToCart(foodListStateController.selectedFood.value,
                      mainStateController.selectedRestaurant.value.restaurantId,
                      quantity: foodDetailStateController.quantity.value),child: Icon(Icons.add_shopping_cart,color: Colors.black),
                  backgroundColor: Colors.white,
                  elevation: 10,
