        ...
        child: Column(
          ...
          children: [
            Text('${foodListStateController.selectedFood.value.name}',
              style: GoogleFonts.jetBrainsMono(color: Colors.blueGrey,fontSize: 20,fontWeight: FontWeight.w900),
            ),
            SizedBox(height: 10,),
            Row(
              ...
              children: [
                Text('\$${foodListStateController.selectedFood.value.price}',
                  style: GoogleFonts.jetBrainsMono(color: Colors.blueGrey,fontWeight: FontWeight.w900,fontSize: 16),
                ),
                Obx(()=>
                    ElegantNumberButton(initialValue: foodDetailStateController.quantity.value,
                minValue: 1,
                maxValue: 20,
                color: Colors.amber,
                    onChanged: (value) {print('Clicked $value'); foodDetailStateController.quantity.value = value.toInt();},
          decimalPlaces: 0))
              ],
            )
          ],
