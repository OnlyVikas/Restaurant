...
import 'package:orders/String/food_list_string.dart';
import 'package:orders/const/const.dart';
import 'package:orders/screen/food_detail.dart';
              ...
              itemBuilder:animationItemBuilder((index)=>
                InkWell(onTap: (){
                      ...
                      Get.to( ()=>FoodDetailScreen());
                        ...
                        child: Hero(tag: categoryStateController.selectedCategory.value.foods[index].name, child: SizedBox(height: MediaQuery.of(context).size.height/6*2,
                              ...
                              Align(alignment: Alignment.bottomCenter,
                                child: Container(
                                  ...
                                  child: Row(mainAxisAlignment: MainAxisAlignment.center,
                                    children: [Padding(padding: const EdgeInsets.only(top: 20,bottom: 20),
                                      child: Row(mainAxisAlignment: MainAxisAlignment.center,
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                SizedBox(width: 50,),
                                                IconButton(onPressed: () => cartStateController.addToCart(categoryStateController.selectedCategory.value.foods[index],mainStateController.selectedRestaurant.value.restaurantId), icon: Icon(Icons.add_shopping_cart,color: Colors.white,))
                                              ],
                                            )
